			...
			<div class="container">
				...
				<ul class="header-links pull-right">
					...
					<%
							...
							%>
					<li><a href="seller_profile.jsp"><i class="fa fa-user-o"></i>
							Profile</a></li>
					<li><span style="color:white;"><b>Welcome <%=u.getFname() %></b></span></li>
					<li><a href="seller_changepassword.jsp"><i class="fa fa-user-o"></i>
						...
						<div class="header-ctn">
							...
							<div class="dropdown">
								<a class="dropdown-toggle" data-toggle="dropdown"
									aria-expanded="true"> <i class="fa fa-list"></i> <span>View 
										Product</span>									
								</a>
